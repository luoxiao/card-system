<?php
header('Content-type: text/html; charset=utf-8'); require_once 'model/builder/AlipayTradePrecreateContentBuilder.php'; require_once 'service/AlipayTradeService.php'; if (!empty($_POST['out_trade_no']) && trim($_POST['out_trade_no']) != '') { $sp58144b = $_POST['out_trade_no']; $spe4243d = $_POST['subject']; $sp6ed116 = $_POST['total_amount']; $spccc814 = '0.01'; $sp1d246b = '购买商品2件共15.00元'; $sp8f1139 = ''; $sp562675 = ''; $sp8261ed = ''; $spaf8aa6 = ''; $sp2684c9 = new ExtendParams(); $sp2684c9->setSysServiceProviderId($spaf8aa6); $spfe934a = $sp2684c9->getExtendParams(); $sp42245d = '5m'; $sp886ee6 = array(); $sp63b18a = new GoodsDetail(); $sp63b18a->setGoodsId('apple-01'); $sp63b18a->setGoodsName('iphone'); $sp63b18a->setPrice(3000); $sp63b18a->setQuantity(1); $sp87bd35 = $sp63b18a->getGoodsDetail(); $sp342c12 = new GoodsDetail(); $sp342c12->setGoodsId('apple-02'); $sp342c12->setGoodsName('ipad'); $sp342c12->setPrice(1000); $sp342c12->setQuantity(1); $sp37a83a = $sp342c12->getGoodsDetail(); $sp886ee6 = array($sp87bd35, $sp37a83a); $sp7f2a58 = ''; $sp4cccca = new AlipayTradePrecreateContentBuilder(); $sp4cccca->setOutTradeNo($sp58144b); $sp4cccca->setTotalAmount($sp6ed116); $sp4cccca->setTimeExpress($sp42245d); $sp4cccca->setSubject($spe4243d); $sp4cccca->setBody($sp1d246b); $sp4cccca->setUndiscountableAmount($spccc814); $sp4cccca->setExtendParams($spfe934a); $sp4cccca->setGoodsDetailList($sp886ee6); $sp4cccca->setStoreId($sp562675); $sp4cccca->setOperatorId($sp8f1139); $sp4cccca->setAlipayStoreId($sp8261ed); $sp4cccca->setAppAuthToken($sp7f2a58); $spd17272 = new AlipayTradeService($spd82bcd); $sp3574b6 = $spd17272->qrPay($sp4cccca); switch ($sp3574b6->getTradeStatus()) { case 'SUCCESS': echo '支付宝创建订单二维码成功:' . '<br>---------------------------------------<br>'; $spfd13d8 = $sp3574b6->getResponse(); $speba27d = $spd17272->create_erweima($spfd13d8->qr_code); echo $speba27d; print_r($spfd13d8); break; case 'FAILED': echo '支付宝创建订单二维码失败!!!' . '<br>--------------------------<br>'; if (!empty($sp3574b6->getResponse())) { print_r($sp3574b6->getResponse()); } break; case 'UNKNOWN': echo '系统异常，状态未知!!!' . '<br>--------------------------<br>'; if (!empty($sp3574b6->getResponse())) { print_r($sp3574b6->getResponse()); } break; default: echo '不支持的返回状态，创建订单二维码返回异常!!!'; break; } return; } ?>
